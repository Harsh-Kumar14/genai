                                ...
                                <div className='file-preview'>
                                    <div className='file-preview__item'>
                                        <div className='file-preview__icon'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M14,2H6A2,2 0 0,0 4,4V20a2,2 0 0,0 2,2H18a2,2 0 0,0 2,-2V8L14,2M7,6H13V8H7V6M7,10H13V12H7V10M7,14H13V16H7V14" /></svg>
                                        </div>
                                        <div className='file-preview__details'>
                                            <p className='file-preview__name'>{uploadedFile.name}</p>
                                            <p className='file-preview__size'>{uploadedFile.size} KB</p>
                                        </div>
                                        <button 
                                            type='button'
